...
import {ArmorMemoryType, HellasArmorItem} from "../HellasArmorItem"

export class HellasArmorItemSheet extends ItemSheet {
	/**
	...
	// @ts-ignore
	getData() {
		let sheet = super.getData() as unknown as ArmorMemoryType
